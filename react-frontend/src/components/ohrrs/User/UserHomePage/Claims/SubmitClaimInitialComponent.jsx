...
class SubmitClaimInitialComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {
            memberId: '',
    ...
    continueClicked() {
        ...
        ViewBillsService.getBillInfo(memberId, token)
            .then(res => {
                this.props.navigate(`/submit-claim-final/${memberId}`);
            })
            .catch(error => {
                const resMessage =
                    (error.response &&
                ...
                <div>
                    ...
                    <header className="masthead" id="our-rooms-header">
                        <div className="container">
                            <div className="masthead-subheading">Please submit the claim by entering details below</div>
                        </div>
                    </header>
                </div>
                <div id="box">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-3">
                                                        <div className="form-btn">
                                                            <button type="button" className="submit-btn" onClick={this.continueClicked}>Continue</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
...
export default SubmitClaimInitialComponent;