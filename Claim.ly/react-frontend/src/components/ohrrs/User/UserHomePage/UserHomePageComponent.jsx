    ...
    return (
      <div className="userHomePageComponent">
        ...
        <section className="page-section bg-light" id="team">
          <div className="container">
            <div className="row">
              <div className="col-lg-8 mx-auto text-center"><p className="large text-muted">We as a team, are working together to provide the customers manage their tasks with ease, through our application</p><h4 className="section-subheading text-muted">Claim.ly</h4></div>
            </div>
          </div>
        </section>
