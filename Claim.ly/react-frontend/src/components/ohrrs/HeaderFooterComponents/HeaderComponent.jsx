                    ...
                    <div className="container">
                        ...
                        <div className="collapse navbar-collapse" id="navbarResponsive">
                            <ul className="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                                ...
                                {isUserLoggedIn && <li><Link className="nav-link" to="/view-bills">View Bills</Link></li>}
                                {isUserLoggedIn && <li><Link className="nav-link" to="/submit-claim">Submit Claim</Link></li>}
                                {isUserLoggedIn && <li><Link className="nav-link" to="/view-claims">Claim Status</Link></li>}
