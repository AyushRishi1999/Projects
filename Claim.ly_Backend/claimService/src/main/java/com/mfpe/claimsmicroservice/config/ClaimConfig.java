...
//		return new Docket(DocumentationType.SWAGGER_2).groupName("Claim Service").apiInfo(apiDetails()).select()
//				.paths(PathSelectors.ant("/claim/**")).build();
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.mfpe"))
